...
<section class="product-details">
    <div class="container ">
        <div class="row mt-3 mb-5">
            <div class="col-md-5">
                <img  src="./../../assets/image/<?= $productInfo['picture'] ?>" width="100%" id="largeImg" alt="">
                <!-- <div class="row mt-2 small">
                    <div class="col-md-3 sm">
                        <img class="small-img " src="./image/bag1.jpg" alt="">
                    </div>
                    <div class="col-md-3 sm">
                        <img class="small-img" src="./image/bag2.jpg" alt="">
                    </div>
                    <div class="col-md-3 sm">
                        <img class="small-img" src="./image/bag3.jpg" alt="">
                    </div>
                    <div class="col-md-3 sm">
                        <img class="small-img" src="./image/bag4.jpg" alt="">
                    </div>
                </div> -->
